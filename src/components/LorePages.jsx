...
export const Page2 = () => (
  <div className="lore-text-content">
    ...
    <p>  ...  </p>
    <p>i medici che la stanno studiando hanno osservato come la sua diffusione sia simile a quella della peste nera diffusasi durante l’era dell’eresia di 350 anni fa. </p>
  </div>
);
...
export const Page3 = () => (
  <div className="lore-text-content">
    ...
    <p>  ...  </p>
    <p>Io e altri miei colleghi crediamo che si comporti in questo modo perché non si diffonde tramite mezzi tradizionali come virus o batteri, anche perche’ sembra che essa non si diffonda al di fuori di Tetai…</p>
  </div>
);
...
export const Page4 = () => (
  <div className="lore-text-content">
    ...
    <p>  ...  </p>
    <p>Dopo una enneamana, il soggetto comincia a farfugliare frasi senza alcun significato, punti in cui aveva prurito si sono ingrossate e gonfiate, si riscontra anche un aumento dell’aggressività.</p>
  </div>
);
...
export const Page6 = () => (
  <div className="lore-text-content">
    ...
    <p>  ...  </p>
    <p>Le sue catacombe ora pullulano di persone e mostri impazziti a causa della pestilenza che diventa più intensa man mano che si scende.</p>
  </div>
);
...
export const Page8 = () => (
  <div className="lore-text-content">
    ...
    <p>  ...  </p>
    <p>La mutazione che li distingue sembra legata a creature del folklore dei luoghi in cui nascono o vivono.
Queste persone non hanno nulla a che fare con la pestilenza.</p>
  </div>
);
...
export const Page9 = () => (
  <div className="lore-text-content">
    ...
    <p>  ...  </p>
    <p>Attualmente l’unica scienziata che sta studiando attivamente i suoi effetti è Violet di Scarlet.</p>
    <p>  ...  </p>
    <p>Non è chiaro se la magia e la pestilenza siano veramente connesse.</p>
  </div>
);
